			...
			<div class="content-box">
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1">
						<div>
							<form  action="/salesmanCooperator/findSalesmanCooperator.do" method="get" data-query-form="">	
								<fieldset>	
									<span>用户名称:<input type="text" class="text-input" name="account" value="${salesmanCooperatorQuery.account }" /></span>
									<span>电话号码:<input type="text" class="text-input" name="phone" value="${salesmanCooperatorQuery.phone }" /></span>
									<span>邮箱:<input type="text" class="text-input" name="mail" value="${salesmanCooperatorQuery.mail }" /></span><br/>
									<span>创建开始时间:<input type="text" class="text-input datetimepicker" name="start_time" value="${salesmanCooperatorQuery.start_time }" /></span>
									<span>创建结束时间:<input type="text" class="text-input datetimepicker" name="end_time" value="${salesmanCooperatorQuery.end_time }" /></span><br/>
...
selectValue("select[name='status']","${salesmanCooperatorQuery.status}");
$(function(){
