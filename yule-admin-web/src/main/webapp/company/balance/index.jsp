			...
			<div class="content-box">
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1">
						<div>
						<form  action="/companyBalance/findCompanyBalances.do" method="get" data-query-form="">
							<fieldset>		
								<span>公司ID:<input type="text" class="text-input" name="company_id" value="${companyBalanceQuery.company_id }" /></span>
								<span>开始时间:<input type="text" class="text-input datetimepicker" name="start_time" value="${companyBalanceQuery.start_time }" /></span>
								<span>结束时间:<input type="text" class="text-input datetimepicker"  name="end_time" value="${companyBalanceQuery.end_time }" /></span><br/>
...
$(function(){
	selectValue("select[name='pay_status']","${companyBalanceQuery.pay_status}");
