...
<link rel="stylesheet" href="http://static.yuleing.com/admin/css/style.css" type="text/css" m	edia="screen" />
			...
			<div class="content-box">
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1">
						<div>
							<form action="/companyUser/findCompanyUser.do" method="get" data-query-form="">
					...
					<div class="tab-content" id="tab2" style="display: none;">
						<form action="/companyUser/insertCompanyUser.do" method="post" ajaxvalidform="" data-url="/companyUser/verifyCompanyUser.do?companyId=${companyId}">
							<fieldset>
								<p>
