			...
			<div class="content-box">
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1">
						<form action="/adminUser/updateAdminUser.do" method="post" validform="">
				           <fieldset>
					            <input type="hidden" name="id" value="${adminUser.id }" />
				                <p>
								   <label>用户名:</label>
								   <input class="text-input small-input" type="text" id="small-input" name="account" value="${adminUser.account }" nullmsg="请输入用户名!" datatype="" errormsg="" /><br />
								</p>
								<p>
								   <label>密码:</label> 
								   <input class="text-input small-input" type="password" id="small-input" name="password"  > <br />
								</p>
								<p>
								   <label>请选择状态</label>
								   ${statusHtml }
...
<script type="text/javascript">
	$(function (){
		selectValue("#status","${adminUser.status}");
	});
</script>
</body>
</html>