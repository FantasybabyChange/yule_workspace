		...
		$(this).each(function(){
			$(this).hover(function(e){
				if(/.png$|.gif$|.jpg$|.bmp$/.test($(this).attr("data-href"))){
					$("body").append("<div id='preview'><div><img src='"+$(this).attr('data-href')+"' /><p>"+$(this).attr('data-title')+"</p></div></div>");
				}else{
					$("body").append("<div id='preview'><div><p>"+$(this).attr('data-title')+"</p></div></div>");
				}
				$("#preview").css({
					position:"absolute",
					padding:"4px",
