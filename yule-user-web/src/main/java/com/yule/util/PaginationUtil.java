...
public class PaginationUtil {
	public static String getPaginationHtml(Page<?> page) {
		...
		paginationHtmls.append("<div class=\"user-page\">");
		paginationHtmls.append("<a href=\""+url+"\" class=\"prev\" data-page=\""+page.getPreviousPage()+"\">&laquo; 上一页</a>");
		int pageCount = page.getPageCount();
		if(pageNo<10){
			if(pageCount>10){
				for (int i = 1; i <= 7; i++) {
					if (i == pageNo) {
						paginationHtmls.append("<a href=\""+url+"\" class=\"current\" data-page=\""+i+"\">" + i + "</a>");
					} else {
		...
		paginationHtmls.append("<a href=\""+url+"\" class=\"next\" data-page=\""+page.getNextPage()+"\">下一页 &raquo;</a>");
