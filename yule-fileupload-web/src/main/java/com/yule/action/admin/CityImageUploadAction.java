...
@Controller
@RequestMapping("/cityImage")
public class CityImageUploadAction extends BaseAction{
...
//			long stratTime = System.currentTimeMillis();
			...
			if(null!=fileUploads&&fileUploads.length>0){
				for(MultipartFile fileUpload:fileUploads){
					...
					String filePath = Const.FILE_IMAGES_DIR+Const.FILE_CITY_DIR+obj.getString(Const.UPLOAD_DIR);
