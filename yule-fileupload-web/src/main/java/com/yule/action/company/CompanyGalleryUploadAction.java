...
public class CompanyGalleryUploadAction extends BaseAction{
	
	private static final String ACTION_PATH = "/company"; 
...
//			logger.info("执行时间:" + DateUtil.dateFormat(new Date(resultTime),"yyyy-MM-dd HH:mm:ss"));
			...
			new YuleException("/companyGallery/upload发生错误!",e);
			e.printStackTrace();
		}
		return null;
	}
