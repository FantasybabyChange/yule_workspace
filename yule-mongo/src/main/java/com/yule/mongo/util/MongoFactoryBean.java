...
//
//	@Override
//	protected Mongo createInstance() throws YuleException {
...
//	 */
//	private Mongo initMongo() throws YuleException {
//		// 根据条件创建Mongo实例
//		Mongo mongo = null;
...
//	 * @throws YuleException
//	 */
//	private List<ServerAddress> getServerList() throws YuleException {
...
//				String host = temp[0];
//				if (temp.length > 2) {
//					throw new IllegalArgumentYuleException(
...
//			throw new YuleException("Error while converting serverString to ServerAddressList", e);
//		}
//	}
//
