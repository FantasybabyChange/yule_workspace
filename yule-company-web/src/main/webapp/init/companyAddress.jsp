...
<head>
						...
						<div class="col-xs-12">
								...
								<div class="widget-box">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">注册必填企业信息</h4>
									</div>
										...
										<div class="widget-main">
											...
											<div id="fuelux-wizard" data-target="#step-container">
												...
												<ul class="wizard-steps">
													...
													<li class="complete"  class="active">
											...
											<div class="step-content pos-rel" id="step-container">
												...
												<div class="step-pane active" id="step2">
													<div class="profile-user-info profile-user-info-striped">
														...
														<div class="profile-info-row">
														<div class="profile-info-name"> 地图定位 </div>
														<div class="profile-info-value">
											...
											<div class="wizard-actions">
												...
												<form action="/init/companyAddress.do" id="step2-form" method="post">
												</form>
	...
	<div id="addrress-wizard"  class="modal" >
		...
		<script src="http://static.yuleing.com/assets/js/fuelux/fuelux.wizard.min.js"></script>
		<script src="http://static.yuleing.com/assets/js/jquery.validate.min.js"></script>
		...
		$(function($){
		   ...
		   initMap("${companyAddressVO.lng}","${companyAddressVO.lat}");
			...
			$(".btn-next").click(function(){
				if(address_detail+city_flag ==0){
					$("#step2-form").submit();
				}else{
					bootbox.alert('请完善您的信息');
				}
			});
		});
		...
		function commonSubmit(tar,value,value1,detail){
			...
			$.ajax({
				url:'/init/updateCompanyAddress.do',
				type:"post",
				dataType:"json",
