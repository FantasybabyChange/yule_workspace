...
<head>
		...
		<link rel="stylesheet" href="http://static.yuleing.com/assets/css/colorbox.css" />
	...
	<body class="no-skin">
						...
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<!-- PAGE CONTENT BEGINS -->
									<div>
										<ul class="ace-thumbnails clearfix" id="product">
											${productGalleryHtmls}
											<!--  
											<li>
		...
		<form action="/productGallery/batchInsertProductGallery.do" method="post" data-ajax="" dataType="json" async="true">
			<fieldset>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				$('#upload').on('click', function(){
					if($(".ace-thumbnails").find("li").length>=10){
						alert("最多只能上传10个图片!");
				    }else{
						...
						modal+='<iframe id="mainFrame" scrolling="auto" width="100%" height="800" src="http://upload.yuleing.com/company/product/upload.html"></iframe></div></div></div></div>';
						var modal = $(modal);
