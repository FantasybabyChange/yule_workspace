...
<head>
	...
	<body class="login-layout light-login">
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red" id="id-text2">企业管理系统</span>
								</h1>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="code" class="form-control" placeholder="企业代码" nullmsg="请输入企业代码!" datatype="*5" nullmsg="请输入新密码" errormsg="" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="captcha" class="col-xs-6" placeholder="验证码"  />
										...
										<div class="widget-main">
											...
											<h4 class="header green lighter bigger" style="display:none">
												...
												<div>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" name="code" datatype="" nullmsg="请输入企业代码!"  placeholder="企业代码" />
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form ajaxSubmit="" >
													...
													<label class="block clearfix">
															<input type="text" class="form-control" name="mail" placeholder="企业邮箱" />
													</label>
		...
		<script src="http://static.yuleing.com/company/js/yule.jquery.captcha.js"></script>
		...
		jQuery(function($) {
			$("form[ajaxvalidform]").find("img[data-src]").click();
			$('body').on('click','#changeToPass',function(){
				$('#forgot-box').find("img[data-src]").click();
			});
			$('body').on('click','#changeToRPass',function(){
				$("form[ajaxvalidform]").find("img[data-src]").click();
			});
			if(errorMessage!=''){
			...
			$('#submitButton').on('click', function() {
				...
				$.ajax({
					url:'/companyCooperator/insertCompanyCooperator.do',
					type:"post",
					dataType:"json",
			...
			$('button[name="sendButton"]').click(function(){
				...
				if(flag){
					...
					$.ajax({
						...
						type:'post',
						data:{'account':forgot.find("input[name='account']").val(),'code':forgot.find("input[name='code']").val()},
						dataType:'json',
						async:false,
						beforeSend :function(){
			...
			$('button[name="surePass"]').click(function(){
				...
				if(flag){
						...
						success:function(data){
							$('span[right-message]').parent().hide();
