...
<head>
		...
		<link rel="stylesheet" href="http://static.yuleing.com/js/jquery.autocomplete.css" />
	...
	<body class="no-skin">
									...
									<div class="tab-content no-border padding-24">
										...
										<div id="feed" class="tab-pane">
											<div class="row">
												...
												<div class="row">
													<div class="col-xs-12">
														<table class="table table-striped table-bordered table-hover" data-url="/balance/findSalesmanBalance.do" data-type="post">
															<thead>
																<tr>
																	<th>日期</th>
																	<th>订单数(笔)</th>
		...
		<!-- yule scripts -->
		<script src="http://static.yuleing.com/salesman/js/yule.jquery.salesman.js"></script>
